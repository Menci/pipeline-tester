...
namespace CodeGen
{
    public class P6Generator : GenerateByInstructionSetAndRandomConfig
    {
        ...
        public override string Name => "Comprehensive test for P6" + (_large ? " (Large)" : "");
        private bool _large;
        public override bool PreloadValue => _large;

        public P6Generator(bool large = false)
        {
            _large = large;
